    ...
    return (
        <section className="max-container">
            <h1 className="head-text">
                Hello, I'm{' '}
                <span className="blue-gradient_text font-semibold drop-shadow">Remus</span>
            </h1>
            <div className="mt-5 flex flex-col gap-3 text-slate-500">
                <p>
                    Front-End developer based in Italy with a keen eye for designing good looking
            ...
            <div className="py-16">
                ...
                <div className="mt-5 flex flex-col gap-3 text-slate-500">
                    <p>
                        ...
                        up with smart people. Hereìs the rundown:
                    </p>
                </div>
